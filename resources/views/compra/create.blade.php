...
@section('content')
    <div class="container-fluid px-4">
        <h1 class="mt-4 text-center text-cafe-oscuro">Crear Compra</h1>
        <ol class="breadcrumb mb-4">
            <li class="breadcrumb-item"><a href="{{ route('panel') }}">Inicio</a></li>
            <li class="breadcrumb-item"><a href="{{ route('compras.index') }}">Compras</a></li>
            <li class="breadcrumb-item active text-cafe-oscuro">Crear Compra</li>
        </ol>
    </div>
    ...
    <form action="{{ route('compras.store') }}" method="post" enctype="multipart/form-data">
        ...
        <div class="container-lg mt-4">
            <div class="row gy-4">
                ...
                {{-- Datos generales --}}
                <div class="col-12">
                    <div class="text-white bg-seccion-venta p-1 text-center">
                        Datos generales
                    </div>
                    <div class="p-3 border border-3 border-seccion-venta">
                        <div class="row g-4">
                            {{-- Proveedor --}}
                            <div class="col-12">
                                ...
                                <select name="proveedore_id" id="proveedore_id" required
                                    class="form-control selectpicker show-tick" data-live-search="true" title="Selecciona"
                                    data-size='2'>
                            ...
                            <div class="col-md-4">
                                <label for="comprobante_id" class="form-label">
                                    Comprobante:</label>
                                <select name="comprobante_id" id="comprobante_id" required class="form-control selectpicker"
                                    title="Selecciona">
                            ...
                            <div class="col-md-4">
                                <label for="file_comprobante" class="form-label">
                                    Archivo:</label>
                                <input type="file" name="file_comprobante" id="file_comprobante" class="form-control"
                                    accept=".pdf">
                            ...
                            <div class="col-md-6">
                                ...
                                <select required name="metodo_pago" id="metodo_pago" class="form-control selectpicker"
                                    title="Selecciona">
                            ...
                            <div class="col-sm-6">
                                <label for="fecha_hora" class="form-label">
                                    Fecha y hora:</label>
                                <input required type="datetime-local" name="fecha_hora" id="fecha_hora" class="form-control"
                                    value="">
                                @error('fecha_hora')
                                    <small class="text-danger">{{ '*' . $message }}</small>
                                @enderror
                    ...
                    <div class="p-3 border border-3 border-seccion-venta">
                        <div class="row g-4">
                            ...
                            <div class="col-12 my-4 text-end">
                                <button id="btn_agregar" class="btn btn-accion" type="button">
                                    Agregar</button>
                            </div>
                ...
                if (parseInt(cantidad) > 0 && (cantidad % 1 == 0) && parseFloat(precioCompra) > 0) {
                    ...
                    if (!arrayIdProductos.includes(idProducto)) {
                        ...
                        let fila = '<tr id="fila' + cont + '">' +
                            ...
                            precioCompra + '</td>' +
                            '<td><input type="hidden" name="arrayfechavencimiento[]" value="' + fechaVencimiento + '">' +
                            fechaVencimiento + '</td>' +
                            '<td>' + subtotal[cont] + '</td>' +
                            '<td><button class="btn btn-danger" type="button" onClick="eliminarProducto(' + cont + ', ' +
                            idProducto + ')"><i class="fa-solid fa-trash"></i></button></td>' +
                            '</tr>';
