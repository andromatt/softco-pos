...
@section('content')
    <div class="container-fluid px-4">
        <h1 class="mt-4 text-center text-cafe-oscuro">Editar Usuario</h1>
        <ol class="breadcrumb mb-4">
            <li class="breadcrumb-item"><a href="{{ route('panel') }}">Inicio</a></li>
            <li class="breadcrumb-item"><a href="{{ route('users.index') }}">Usuarios</a></li>
            <li class="breadcrumb-item active text-cafe-oscuro">Editar Usuario</li>
        </ol>
                        ...
                        <div class="col-lg-4">
                            <select name="role" id="role" class="form-select">
                                @foreach ($roles as $item)
                                    <option value="{{ $item->name }}" @selected(in_array($item->name, $user->roles->pluck('name')->toArray()) || old('role') == $item->name)>
                                        {{ $item->name }}
                                    </option>
                                @endforeach
                            </select>
