...
@section('content')
    ...
    <div class="container-fluid px-4">
        <h1 class="mt-4 text-center text-cafe-oscuro">Usuarios</h1>
        <ol class="breadcrumb mb-4">
            <li class="breadcrumb-item"><a href="{{ route('panel') }}">Inicio</a></li>
            <li class="breadcrumb-item active text-cafe-oscuro">Usuarios</li>
        </ol>
                                            ...
                                            <ul class="dropdown-menu text-bg-light" style="font-size: small;">
                                                ...
                                                @can('editar-user')
                                                    <li><a class="dropdown-item"
                                                            href="{{ route('users.edit', ['user' => $item]) }}">Editar</a></li>
                                                @endcan
                                            </ul>
                                        </div>
                                        <div>
