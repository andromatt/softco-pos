...
@section('content')
    <div class="container-fluid px-4">
        <h1 class="mt-4 text-center text-cafe-oscuro">Mi empresa</h1>

        <x-breadcrumb.template>
            <x-breadcrumb.item :href="route('panel')" content="Inicio" />
            <x-breadcrumb.item active='true' content="Mi empresa" class="text-cafe-oscuro" />
        </x-breadcrumb.template>
        ...
        <x-forms.template :action="route('empresa.update', ['empresa' => $empresa])" method='post' patch='true'>
            ...
            <div class="row g-4">
                ...
                <div class="col-md-6">
                    <x-forms.input id="porcentaje_impuesto" required='true' :defaultValue='$empresa->porcentaje_impuesto' type='number'
                        labelText='Porcentaje del impuesto (%)' />
                </div>
