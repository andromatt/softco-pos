...
@section('content')
    <div class="container-fluid px-4">
        <h1 class="mt-4 text-center text-cafe-oscuro">Crear Cliente</h1>
        <ol class="breadcrumb mb-4">
            <li class="breadcrumb-item"><a href="{{ route('panel') }}">Inicio</a></li>
            <li class="breadcrumb-item"><a href="{{ route('clientes.index') }}">Clientes</a></li>
            <li class="breadcrumb-item active text-cafe-oscuro">Crear cliente</li>
        </ol>
            ...
            <form action="{{ route('clientes.store') }}" method="post">
                ...
                <div class="card-body">
                    ...
                    <div class="row g-3">
                        ...
                        {{-- Tipo de cliente (General o Físico) --}}
                        <div class="col-md-6">
                            ...
                            <select class="form-select" name="documento_id" id="documento_id">
                                ...
                                @foreach ($documentos as $item)
                                    <option value="{{ $item->id }}"
                                        {{ old('documento_id') == $item->id ? 'selected' : '' }}>{{ $item->nombre }}
                                    </option>
                                @endforeach
                            </select>
                            @error('documento_id')
