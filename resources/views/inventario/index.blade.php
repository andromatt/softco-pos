...
@section('content')
    ...
    <div class="container-fluid px-4">
        <h1 class="mt-4 text-center text-cafe-oscuro">Inventario</h1>

        <x-breadcrumb.template>
            <x-breadcrumb.item :href="route('panel')" content="Inicio" />
            <x-breadcrumb.item active='true' content="Inventario" class="text-cafe-oscuro" />
        </x-breadcrumb.template>

        <div class="mb-4">
            <button type="button" class="btn btn-accion" data-bs-toggle="modal" data-bs-target="#verPlanoModal">
                Ver plano
            </button>
        </div>
            ...
            <div class="modal-dialog modal-xl modal-dialog-scrollable">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5 text-cafe-oscuro" id="exampleModalLabel">Plano de Ubicaciones</h1>
