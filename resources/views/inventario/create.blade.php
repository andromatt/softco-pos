...
@section('content')
    <div class="container-fluid px-4">
        <h1 class="mt-4 text-center text-cafe-oscuro">Inicializar Producto</h1>

        <x-breadcrumb.template>
            <x-breadcrumb.item :href="route('panel')" content="Inicio" />
            <x-breadcrumb.item :href="route('productos.index')" content="Productos" />
            <x-breadcrumb.item active='true' content="Inicializar producto" class="text-cafe-oscuro" />
        </x-breadcrumb.template>
        ...
        <x-forms.template :action="route('inventario.store')" method='post'>
            ...
            <div class="row g-4">
                ...
                <div class="col-6">
                    ...
                    <select name="ubicacione_id" id="ubicaciones_id" class="form-select">
