...
@section('content')
    ...
    <div class="container-fluid px-4">
        <h1 class="mt-4 text-center text-cafe-oscuro">Presentaciones</h1>
        <ol class="breadcrumb mb-4">
            <li class="breadcrumb-item"><a href="{{ route('panel') }}">Inicio</a></li>
            <li class="breadcrumb-item active text-cafe-oscuro">Presentaciones</li>
        </ol>
                    ...
                    <tbody>
                        @foreach ($presentaciones as $item)
                            <tr>
                                ...
                                <td>
                                    <span
                                        class="badge rounded-pill text-bg-{{ $item->caracteristica->estado ? 'success' : 'danger' }}">
