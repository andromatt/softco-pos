...
@section('content')
    ...
    <div class="container-fluid px-4">
        <h1 class="mt-4 text-center text-cafe-oscuro">Proveedores</h1>
        <ol class="breadcrumb mb-4">
            <li class="breadcrumb-item"><a href="{{ route('panel') }}">Inicio</a></li>
            <li class="breadcrumb-item active text-cafe-oscuro">Proveedores</li>
        </ol>
                    ...
                    <tbody>
                        @foreach ($proveedores as $item)
                            <tr>
                                ...
                                <td>
                                    <span
                                        class="badge rounded-pill text-bg-{{ $item->persona->estado ? 'success' : 'danger' }}">
                                            ...
                                            <ul class="dropdown-menu text-bg-light" style="font-size: small;">
                                                ...
                                                @can('editar-proveedore')
                                                    <li><a class="dropdown-item"
                                                            href="{{ route('proveedores.edit', ['proveedore' => $item]) }}">Editar</a>
                                                    </li>
                                                @endcan
                                            </ul>
                                        </div>
