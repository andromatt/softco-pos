...
@section('content')
    <div class="container-fluid px-4">
        <h1 class="mt-4 text-center text-cafe-oscuro">Ver Venta</h1>
        <ol class="breadcrumb mb-4">
            <li class="breadcrumb-item"><a href="{{ route('panel') }}">Inicio</a></li>
            <li class="breadcrumb-item"><a href="{{ route('ventas.index') }}">Ventas</a></li>
            <li class="breadcrumb-item active text-cafe-oscuro">Ver Venta</li>
        </ol>
    </div>
        ...
        <div class="card mb-2">
            ...
            <div class="card-body table-responsive">
                <table class="table table-striped">
                    <thead class="bg-seccion-venta text-white">
                        <tr class="align-top">
                    ...
                    <tfoot>
                        ...
                        <tr>
                            <th colspan="4">{{ $empresa->abreviatura_impuesto }}
