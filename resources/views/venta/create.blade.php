...
@section('content')
    <div class="container-fluid px-4">
        <h1 class="mt-4 text-center text-cafe-oscuro">Realizar Venta</h1>
        <ol class="breadcrumb mb-4">
            <li class="breadcrumb-item"><a href="{{ route('panel') }}">Inicio</a></li>
            <li class="breadcrumb-item"><a href="{{ route('ventas.index') }}">Ventas</a></li>
            <li class="breadcrumb-item active text-cafe-oscuro">Realizar Venta</li>
        </ol>
    </div>
                                ...
                                <div class="table-responsive">
                                    <table id="tabla_detalle" class="table table-hover">
                                        ...
                                        <tfoot>
                                            ...
                                            <tr>
                                                <th colspan="4">
                                                    {{ $empresa->abreviatura_impuesto }}
                                                    ({{ $empresa->porcentaje_impuesto }})%
                                                </th>
                                                <th colspan="2">
                                                    <input type="hidden" name="impuesto" id="inputImpuesto"
                                                        value="0">
                                                    <span id="igv">0</span>
                                                    <span>{{ $empresa->moneda->simbolo }}</span>
                                                </th>
                    ...
                    <div class="p-3 border border-3 border-seccion-venta">
                        ...
                        <div class="row gy-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" id="dinero_recibido" name="monto_recibido" class="form-control"
                                    step="any">
                            </div>
