...
@section('content')
    ...
    <div class="container-fluid px-4">
        <h1 class="mt-4 text-center text-cafe-oscuro">Cajas</h1>

        <x-breadcrumb.template>
            <x-breadcrumb.item :href="route('panel')" content="Inicio" />
            <x-breadcrumb.item active='true' content="Cajas" class="text-cafe-oscuro" />
        </x-breadcrumb.template>

        @can('aperturar-caja')
            <div class="mb-4">
                <a href="{{ route('cajas.create') }}">
                    <button type="button" class="btn btn-accion">Aperturar caja</button>
                </a>
            </div>
        @endcan
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <form action="{{ route('cajas.destroy', ['caja' => $item->id]) }}"
                                                method="post">
                                                @method('DELETE')
                                                @csrf
