...
@section('content')
    ...
    <div class="container-fluid px-4">
        <h1 class="mt-4 text-center text-cafe-oscuro">Categorías</h1>

        <x-breadcrumb.template>
            <x-breadcrumb.item :href="route('panel')" content="Inicio" />
            <x-breadcrumb.item active='true' content="Categorías" class="text-cafe-oscuro" />
        </x-breadcrumb.template>
                    ...
                    <tbody>
                        @foreach ($categorias as $categoria)
                            <tr>
                                ...
                                <td>
                                    <span
                                        class="badge rounded-pill text-bg-{{ $categoria->caracteristica->estado ? 'success' : 'danger' }}">
                            ...
                            {{-- Modal de eliminar/restaurar categoría --}}
