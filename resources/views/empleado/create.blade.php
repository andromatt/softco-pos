...
@section('content')
    <div class="container-fluid px-4">
        <h1 class="mt-4 text-center text-cafe-oscuro">Crear Empleado</h1>

        <x-breadcrumb.template>
            <x-breadcrumb.item :href="route('panel')" content="Inicio" />
            <x-breadcrumb.item :href="route('empleados.index')" content="Empleados" />
            <x-breadcrumb.item active='true' content="Crear empleado" class="text-cafe-oscuro" />
        </x-breadcrumb.template>
        ...
        <x-forms.template :action="route('empleados.store')" method='post' file='true'>
            ...
            <div class="row g-4">
                ...
                <div class="col-md-6">
                    ...
                    <img id="img-default" class="img-fluid" src="{{ asset('assets/img/paisaje.png') }}"
