...
@section('content')
    <div class="container-fluid px-4">
        <h1 class="mt-4 text-center text-cafe-oscuro">Editar Empleado</h1>

        <x-breadcrumb.template>
            <x-breadcrumb.item :href="route('panel')" content="Inicio" />
            <x-breadcrumb.item :href="route('empleados.index')" content="Empleados" />
            <x-breadcrumb.item active='true' content="Editar empleado" class="text-cafe-oscuro" />
        </x-breadcrumb.template>

        <x-forms.template :action="route('empleados.update', ['empleado' => $empleado])" method='post' file='true' patch='true'>

            <div class="row g-4">

                <div class="col-md-6">
                    <x-forms.input id="razon_social" required='true' labelText='Nombres y Apellidos' :defaultValue='$empleado->razon_social' />
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <img id="img-default" class="img-fluid"
